...
PROC="$(ps -eo pid,etime,cmd | grep -E 'train_shoulder4_frozen.py.*KinematicScratchCrossDelta|run_kinematic_scratch_crossdelta300_progress.sh' | grep -v grep | sed -n '1,3p')"
SCALARS=""
if [ -n "$LOG" ]; then
...
cat <<OUT
T1 Kinematic Scratch CrossDelta Progress Dashboard
======================================================================
Run:   T1Shoulder4 Kinematic Scratch CrossDelta model_300
...
Side:  cross-side roll, right leg outward raises left arm; left leg raises right
