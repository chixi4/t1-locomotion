...
PROC="$(ps -eo pid,etime,cmd | grep -E 'train_shoulder4_frozen.py.*KinematicScratchCrossSide|run_kinematic_scratch_crossside300_progress.sh' | grep -v grep | sed -n '1,3p')"
SCALARS=""
if [ -n "$LOG" ]; then
...
cat <<OUT
T1 Kinematic Scratch CrossSide Progress Dashboard
======================================================================
Run:   T1Shoulder4 Kinematic Scratch CrossSide model_300
